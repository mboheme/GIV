<?php include('include/form_logout.php') ?>
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal tasi-form" method="get">
                <div class="form-group has-success">
                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">Vous avez été déconnecté du serveur avec succès !</label>                  
                </div>
                <div  hidden="true" class="form-group has-warning">
                  <label class="col-sm-2 control-label col-lg-2" for="inputWarning">Input with warning</label>
                  <div class="col-lg-10">
                    <input type="text" class="form-control" id="inputWarning">
                  </div>
                </div>
                <div hidden="true" class="form-group has-error">
